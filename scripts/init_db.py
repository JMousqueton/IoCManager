...
def create_all_tables():
    ...
    with app.app_context():
        ...
        print("  - Users")
        print("  - IOC Types")
        print("  - IOCs (with lifecycle status: draft | review | active | archived, share_token for public links)")
        print("  - Tags")
...
def show_database_info():
    ...
    with app.app_context():
        ...
        shared_count = IOC.query.filter(IOC.share_token.isnot(None)).count()
        ...
        print(f"    - With share token: {shared_count}")
